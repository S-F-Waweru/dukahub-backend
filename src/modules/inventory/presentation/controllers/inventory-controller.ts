...
,
    ...
    @ApiOperation({
        ...
        description: 'Create a new product with optional variants. Supports simple products and products with multiple variants (size, color, etc.)'
    })
    @ApiResponse({
        status: 201,
    ...
    @ApiOperation({
        ...
        description: 'Get all products for the current merchant with optional category filtering'
    })
    @ApiQuery({
        name: 'categoryId',
        required: false,
    ...
    @ApiOperation({
        ...
        description: 'Get all products that are at or below their reorder point threshold'
    })
    @ApiResponse({
        status: 200,
    ...
    @ApiOperation({
        ...
        description: 'Soft delete a product. Product can only be deleted if all variants have zero stock.'
    })
    @ApiParam({ name: 'id', description: 'Product UUID' })
