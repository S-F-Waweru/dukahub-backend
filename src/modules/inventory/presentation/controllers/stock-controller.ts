...
export class StockController {
    ...
    @ApiOperation({
        ...
        description: 'Add stock to a product variant. Creates an audit trail record.'
    })
    @ApiResponse({
        status: 200,
    ...
    @ApiOperation({
        ...
        description: 'Remove stock from a product variant. Triggers low-stock alerts and KES 10k threshold tracking.'
    })
    @ApiResponse({
        status: 200,
    ...
    @ApiOperation({
        ...
        description: 'Manually adjust stock level (for corrections, damaged goods, etc.)'
    })
    @ApiResponse({
        status: 200,
    ...
    @ApiOperation({
        ...
        description: 'Get complete audit trail of stock movements for a product variant'
    })
