...
class VariantDto {
  ...
  @ApiPropertyOptional({
    example: 10,
    description: 'Reorder point for this variant',
  })
  @IsOptional()
  @IsNumber()
  @Min(0)
...
export class CreateProductDto {
  ...
  @ApiPropertyOptional({
    example: 'Classic African literature by Chinua Achebe',
  })
  @IsOptional()
  @IsString()
  description?: string;
  ...
  @ApiProperty({
    example: false,
    description: 'Does product have variants (size, color, etc.)',
  })
  @IsBoolean()
  hasVariants: boolean;
