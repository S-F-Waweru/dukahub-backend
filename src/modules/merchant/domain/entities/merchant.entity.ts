...
export class Merchant extends BaseEntity {
    ...
    // Getters
    get businessName(): BusinessName { return this._businessName; }
    get type(): MerchantType { return this._type; }
    get phoneNumber(): string { return this._phoneNumber; }
    get email(): string { return this._email; }
    get physicalAddress(): string | undefined { return this._physicalAddress; }
    get kraPin(): KraPin | undefined { return this._kraPin; }
    get mpesaTill(): string | undefined { return this._mpesaTill; }
    get airtelMoneyNumber(): string | undefined { return this._airtelMoneyNumber; }
    get status(): MerchantStatus { return this._status; }
    get subscriptionTier(): string { return this._subscriptionTier; }
    get onboardedAt(): Date { return this._onboardedAt; }
}