...
export class GmailEmailService implements IEmailSenderService {
  ...
  async sendVerificationEmail(to: Email, token: string): Promise<void> {
    ...
    const mailOptions = {
      from: this.fromEmail,
      to: to.value,
      subject: 'Verify Your Email - DukaHub',
      html: `
        <!DOCTYPE html>
        <html>
          <head>
  ...
  async sendPasswordResetEmail(to: Email, token: string): Promise<void> {
    ...
    const mailOptions = {
      from: this.fromEmail,
      to: to.value,
      subject: 'Reset Your Password - DukaHub',
      html: `
        <!DOCTYPE html>
        <html>
          <head>
  ...
  async sendInvitationEmail(
    ...
    const mailOptions = {
      from: this.fromEmail,
      to: to.value,
      subject: "You've Been Invited to Join DukaHub",
      html: `
        <!DOCTYPE html>
        <html>
          <head>
          ...
          <body>
            <div class="container">
              ...
              <p>You've been invited to join a DukaHub merchant account as a <span class="role-badge">${role}</span>.</p>
